...
DARESULT_DIR=results/vm/choose_machine/sb/dafjs
MKRESULT_DIR=results/vm/mk
DPRESULT_DIR=results/vm/dauzere
FRESULT_DIR=results/vm/fmj
HUERESULT_DIR=results/vm/edata
HURRESULT_DIR=results/vm/rdata
HUVRESULT_DIR=results/vm/vdata
...
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs01 2>&1 | tee $FRESULT_DIR/sfjs01.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs02 2>&1 | tee $FRESULT_DIR/sfjs02.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs03 2>&1 | tee $FRESULT_DIR/sfjs03.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs04 2>&1 | tee $FRESULT_DIR/sfjs04.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs05 2>&1 | tee $FRESULT_DIR/sfjs05.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs06 2>&1 | tee $FRESULT_DIR/sfjs06.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs07 2>&1 | tee $FRESULT_DIR/sfjs07.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs08 2>&1 | tee $FRESULT_DIR/sfjs08.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs09 2>&1 | tee $FRESULT_DIR/sfjs09.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/sfjs10 2>&1 | tee $FRESULT_DIR/sfjs10.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs01 2>&1 | tee $FRESULT_DIR/mfjs01.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs02 2>&1 | tee $FRESULT_DIR/mfjs02.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs03 2>&1 | tee $FRESULT_DIR/mfjs03.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs04 2>&1 | tee $FRESULT_DIR/mfjs04.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs05 2>&1 | tee $FRESULT_DIR/mfjs05.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs06 2>&1 | tee $FRESULT_DIR/mfjs06.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs07 2>&1 | tee $FRESULT_DIR/mfjs07.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs08 2>&1 | tee $FRESULT_DIR/mfjs08.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs09 2>&1 | tee $FRESULT_DIR/mfjs09.log
# ./runlim -r $TO -s $MO  python3 -u main.py $FDATA_DIR/mfjs10 2>&1 | tee $FRESULT_DIR/mfjs10.log
