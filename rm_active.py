...
def build_constraints(solver, num_operations, precedence_list, request_list, in_degree, feasible_time, s, x, m, top_id):
    # (4) tạo dãy order
    for i in range(num_operations):
...
def main():
    ...
    build_constraints(solver, num_operations, precedence_list, request_list, in_degree, feasible_time, s, x, m, top_id)
